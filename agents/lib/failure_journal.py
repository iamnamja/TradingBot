...
def build_failure_remediation_plan(
    *,
    ...
    plan = {
        ...
        "compatibility_surface_kind": str(route.get("compatibility_surface_kind") or ""),
        "compatibility_surface_symbol": str(route.get("compatibility_surface_symbol") or ""),
        "coupled_repair_set_inferred": bool(route.get("coupled_repair_set_inferred", False)),
        "compatibility_surface_files": [str(item) for item in route.get("compatibility_surface_files") or [] if str(item)],
