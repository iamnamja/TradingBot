...
def execute_safe_lane_scheduler_mix_policy(
    *,
    queue: list[TaskQueueItem],
    completed_task_paths: list[str] | None = None,
    task_text_loader: Callable[[str], str] | None = None,
    task_runner: Callable[..., dict[str, object]] | None = None,
    policy_artifact_path: str | None = None,
    now: Callable[[], str] | None = None,
    **runner_kwargs: Any,
) -> dict[str, object]:
    from agents.run_single_task import run_scheduler_safe_lane_bridge

    return dict(
        run_scheduler_safe_lane_bridge(
            queue,
