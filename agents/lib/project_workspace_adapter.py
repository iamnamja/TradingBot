...
def tradingbot_workspace_contract(workspace_root: str = '.') -> dict[str, object]:
    return canonical_workspace_contract(
        ...
        artifact_output_paths=['artifacts', 'tasks/state.json', 'last_output.txt', '_last_agent_model_output.txt', '_last_agent_file_bundle.txt', '_last_agent_file_bundle_error.txt', '_last_subset_preservation.json'],
